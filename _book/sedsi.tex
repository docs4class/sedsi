...
\caption{\label{tab:unnamed-chunk-4}A table of the first 10 rows of the mtcars data.}
\centering
...
\hypertarget{another-fun-example}{%
\subsection{ANOTHER Fun example}\label{another-fun-example}}

\begin{table}
\caption{\label{tab:unnamed-chunk-5}A Tale of Two Tables.}
...
\includegraphics{_images/r.png} \includegraphics{_images/rstudio.png} \includegraphics{_images/bookdown.png} \includegraphics{_images/github.png} \includegraphics{_images/netlify.png}
