...
Show the student data as an en exaple of reproducible research--\textgreater{}
...
Footnotes are put inside the square brackets after a caret \footnote{}. Like this one.1
...
\caption{\label{tab:unnamed-chunk-6}A table of the first 10 rows of the mtcars data.}
\centering
...
\CommentTok{\#\textgreater{} Updates are available on the coronavirus Dev version, do you want to update? n/Y}
\end{Highlighting}
\end{Shaded}
