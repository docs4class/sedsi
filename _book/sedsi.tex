...
\includegraphics{_images/r.jpg} \includegraphics{_images/rstudio.png} \includegraphics{_images/bookdown.png} \includegraphics{_images/github.png} \includegraphics{_images/netlify.png}

A Learning Management System Nightmare

\includegraphics{_images/empty_class.jpg}

Concise and Precisely Organized with Frequent Revisions

\includegraphics{_images/r4ds_cover.png}

\includegraphics{_images/rstudio.png}

\includegraphics{_images/rstudio.png} \includegraphics{_images/rstudio.png} \includegraphics{_images/rstudio.png}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\StringTok{"\_images/rstudio.png"}\NormalTok{, }\DecValTok{3}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{_images/rstudio.png} \includegraphics{_images/rstudio.png} \includegraphics{_images/rstudio.png}

\hypertarget{hello-sedsi}{%
\chapter{Hello SEDSI}\label{hello-sedsi}}
